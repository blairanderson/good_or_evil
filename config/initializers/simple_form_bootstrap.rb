SimpleForm.setup do |config|
  ...
  config.button_class = 'b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib'
  config.boolean_label_class = 'pa0 ma0 lh-copy f6 pointer'
  config.default_form_class = 'center'
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    ...
    b.use :input, class: 'pa2 input-reset ba bg-transparent w-100'
